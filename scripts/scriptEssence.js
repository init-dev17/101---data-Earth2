  ...
  new Chart(ctxEssence, {
    ...
    data: {
      ...
      datasets: /*ordonnées*/ [
        ...
        {
          label: "Circulating supply (ESS)",
          //data: ['1', '2', '3', '4', '5', '6'],
          data: data4.map((row) => row.MINTED_TOKENS - row.BURNT_TOKENS),
          borderColor: "rgb(81,226,195)",
          backgroundColor: "rgb(81,226,195)",
        },
        {
          label: "Staked in Mentars (ESS)",
          //data: ['1', '2', '3', '4', '5', '6'],
          data: data4.map((row) => row.ESSENCE_STAKED_IN_MENTAR),
          borderColor: "Blue",
